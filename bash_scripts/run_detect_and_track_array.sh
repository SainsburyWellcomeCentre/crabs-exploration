...
# Example 1: to evaluate all mp4 videos in a directory
# VIDEOS_DIR=<path-to-videos>
# CKPT_FILENAME=*.mp4

# Example 2: to evaluate all 'last' checkpoints of an MLflow experiment
# VIDEOS_DIR=/ceph/zoo/users/sminano/ml-runs-all/ml-runs-scratch/763954951706829194/*/checkpoints
# VIDEO_FILENAME=last.ckpt

# Example 3: to evaluate all 'checkpoint-epoch=' checkpoints of an MLflow experiment,
# VIDEOS_DIR=/ceph/zoo/users/sminano/ml-runs-all/ml-runs-scratch/763954951706829194/*/checkpoints
# VIDEO_FILENAME=checkpoint-epoch=*.ckpt
...
VIDEOS_DIR=">path-to-escape-clips-directory"
VIDEO_FILENAME=*.mp4
